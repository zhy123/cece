...
function twentyeleven_content_nav( $html_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
		<nav id="<?php echo esc_attr( $html_id ); ?>">
			...
			<div class="nav-previous"><?php previous_posts_link( __( '<span class="meta-nav">&larr;</span> 上一页', 'twentyeleven' ) ); ?></div>
			<div class="nav-next"><?php next_posts_link( __( '下一页 <span class="meta-nav">&rarr;</span>', 'twentyeleven' ) ); ?></div>
		</nav><!-- #nav-above -->
	<?php endif;
}
